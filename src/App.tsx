...
const LandingPage = () => {
  ...
  const testimonials = [
    {
      id: 1,
      quote: "O Italo transformou completamente minha relação com a matemática. Suas aulas são claras e objetivas!",
      author: "Ana Clara, aluna Tessat Edu",
    },
    {
      id: 2,
      quote: "Professor dedicado e com metodologia inovadora. Meu filho melhorou significativamente suas notas.",
      author: "Carlos Silva, pai de aluno",
    },
    {
      id: 3,
      quote: "As aulas do Tessat Edu foram essenciais para minha aprovação no vestibular. Recomendo a todos!",
      author: "Mariana Oliveira, ex-aluna",
    },
  ];
      ...
      <header className="header">
        <div className="header-container">
          ...
          <nav className="nav">
            ...
            <span className="nav-item" onClick={()=>scrollToSection('depoimentos')}>Depoimentos</span>
          ...
          <nav className={`mobile-nav ${isMenuOpen?'open':''}`}>
            ...
            <span className="mobile-nav-item" onClick={()=>scrollToSection('depoimentos')}>Depoimentos</span>
